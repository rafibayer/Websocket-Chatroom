...
class TestServer(unittest.TestCase):
    ...
    def test_name_change(self):
        ...
        self.assertIn(room.get_name_change_notification("old_name", "new_name"), room.connected[fake_websocket].websocket.incoming)
        self.assertIn(room.get_name_change_notification("old_name", "new_name"), room.connected[fake_websocket2].websocket.incoming)
